...
export type { Called } from "./contracts/test/called.sol/Called";
export { Called__factory } from "./factories/contracts/test/called.sol/Called__factory";
export type { CalledProxy } from "./contracts/test/called.sol/CalledProxy";
