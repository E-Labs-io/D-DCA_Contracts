...
export interface DCAAccountFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "createDCAAccount"
...
export interface DCAAccountFactory extends BaseContract {
  connect(runner?: ContractRunner | null): DCAAccountFactory;
  waitForDeployment(): Promise<this>;

  interface: DCAAccountFactoryInterface;
