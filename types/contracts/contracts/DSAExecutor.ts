...
export interface DSAExecutorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "Active"
      | "CheckIfAdmin"
...
export interface DSAExecutor extends BaseContract {
  connect(runner?: ContractRunner | null): DSAExecutor;
  waitForDeployment(): Promise<this>;

  interface: DSAExecutorInterface;
